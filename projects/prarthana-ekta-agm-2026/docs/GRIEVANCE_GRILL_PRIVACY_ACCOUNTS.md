...
**Ground-floor units** (revised 04-Sep-2026: G-1, G-2 and G-3 are all shops)
...
| F2 | The open border (setback) around the building is roughly 3 to 4 times wider on the Chairman's side than on mine. My side is also the sole pedestrian route to the lift entrance. | Measurements in metres of both sides (before and after the Chairman's grill), photos with tape visible |
| F3 | The flat opposite G-4 is **G-1, the Chairman's own residence (Mr. Magdoom Panchmahal)**. Its window grill has been extended outward into the open border (setback) of the building, not into an internal passage. When I fitted my safety-door grill and was about to extend the window grill, someone from the society told the welder to stop. No one told me directly and nothing was in writing. The Treasurer later declined informally. **No written request has been made yet.** | Welder's name and date of the stopped work; photo of G-1 grill in the setback; my safety-door grill invoice |
...
| F12 | Members park two-wheelers in the wider setback area below the Chairman's window. The wider side is therefore blocked, and foot traffic to the lift is pushed through the narrower setback on my side. | Photos of the parked bikes at different times; count of bikes; SRA plan showing whether that area is marked as parking |
...
**There is no SRA or bye-law clause that gives a member a right to extend a grill into a common passage.**
A grill projecting beyond the flat's external wall sits on common area. Under the Maharashtra Co-operative Societies Act 1960 (MCS Act), the Model Bye-laws for co-operative housing societies, and the SRA-sanctioned building plan, common areas belong to the society and cannot be occupied by any single member. Projections into passages are also a fire-escape obstruction (Maharashtra Fire Prevention and Life Safety Measures Act 2006) and an unauthorised alteration under Section 351 of the Mumbai Municipal Corporation Act 1888.

**What the law does give you is equal treatment.** The committee must apply the bye-laws uniformly. Allowing one member's grill and refusing yours is arbitrary and discriminatory, and that is challengeable. In practice this leads to one of two outcomes:

| Outcome | How | Pros | Cons |
|---|---|---|---|
...
**The bike parking turns the setback argument around.** The wider setback below the Chairman's window is used as two-wheeler parking. That means:

1. The committee cannot refuse your grill on "open-space width" while allowing the wide setback to be filled with bikes. Its concern for clear open space is selective, and selective enforcement is the discrimination you need to show.
2. Parking on society common space needs a general-body resolution, an allotment list and parking charges under Model Bye-laws 78 to 84. Ask for all three. If they do not exist, the parking is as unauthorised as any grill.
3. Unless the SRA-sanctioned plan marks that area as parking, two-wheelers in the setback obstruct the fire-tender access route, the very ground the committee would use against you.
4. The bikes are the real cause of your privacy problem: the wide route is blocked, so every resident and visitor is funnelled past the G-4 window.

**The resolution to move at the AGM (item 4):** "The wider setback on the Chairman's side shall be kept as the main pedestrian route to the lift entrance. Two-wheelers shall be relocated to the area designated by the general body, and parking shall be allotted and charged as per the bye-laws. A flush privacy screen shall be fitted along the window of G-4 at society cost, and a wall-mounted shoe cabinet or a marked space for the shoe rack of G-4 shall be provided near its door, as every other member keeps a rack outside their flat." This gives you privacy without needing a grill, and it is hard to vote against because it is framed as fire safety and fairness, not as a personal demand.
...
Verify numbers against your registered bye-laws (2014 Model Bye-laws for co-operative housing societies unless the society adopted another version).

| Issue | Provision | Use |
|---|---|---|
| Additions / alterations need written committee permission; committee must decide in the prescribed time | Model Bye-law 48 (structural changes) with Bye-law 47 (repairs) | Your request was ignored or refused while another was allowed |
| Common areas cannot be encroached; society must maintain them for all members | Bye-laws on common areas and the SRA-sanctioned plan under DCPR 2034 Reg. 33(10) | Both grills are on common area; demand a uniform rule |
| Member's right to inspect and obtain copies of books, accounts, minutes | MCS Act Sec. 32; Model Bye-law on inspection/copies of documents (approx. Bye-law 172) | Demand monthly income and expenditure statements |
| Government directives on transparency and management of housing societies | MCS Act Sec. 79A; Chapter XIII-B (Sec. 154B series, 2019 amendment) | Basis for a resolution to circulate monthly statements |
...
2. **Raise at the AGM on 27 Sep 2026** under item 4 and ask that your points and the committee's reply be recorded in the minutes. Move a resolution on each point and ask for a show of hands.
...
To,
The Hon. Secretary / Managing Committee,
Prarthana-Ekta SRA Co-op. Hsg. Society Ltd.,
Bhatt Lane, Poisar, Kandivali (West), Mumbai – 400 067
...
Name / Flat No. / Mobile
Encl.: photos and measurements of both passages; copy of earlier request dated ______
