...
def process_message(user_message: str, chat_history: list = None) -> str | tuple:
    ...
    SPECIALIST_TRIGGERS = ["lawyer", "web", "designer", "hardware", "server", "musician", "gofrugal", "email", "personal", "insurance", "education", "youtube_growth", "marathi", "hindi", "tester", "debugger", "playwright", "crawler", "bank_ocr"]
